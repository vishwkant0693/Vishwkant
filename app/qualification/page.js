  ...
  return (
    <>
      <section className="qualification min-h-screen">
        ...
        <div className="flex flex-col justify-around py-10 bg-zinc-900 rounded-xl w-4/5 mx-auto px-10 my-8 border border-gray-500">
          <h4 className="text-xl py-3 max-sm:text-lg flex items-center gap-2"><box-icon name='institution' type='solid' ></box-icon>Python Full Stack</h4>
          ...
          <hr />
          <h4 className="text-xl py-3 max-sm:text-lg flex items-center gap-2"><box-icon type='solid' name='graduation'></box-icon>Graduation</h4>
          <h5 className="flex justify-between pl-8 py-1 max-sm:text-xs max-sm:flex-col">
          ...
          <hr />
          <h4 className="text-xl py-3 max-sm:text-lg flex items-center gap-2"><box-icon name='school' type='solid' ></box-icon>Class XII</h4>
          <h5 className="flex justify-between pl-8 py-1 max-sm:text-xs max-sm:flex-col">
            <div className="qual-title col-md-6">CBSE BOARD - RSBV Kalyanpuri</div>
            <div className="qual-year col-md-6">2018</div>
          </h5>
          <hr />
          <h4 className="text-xl py-3 max-sm:text-lg flex items-center gap-2"><box-icon name='school' type='solid' ></box-icon>Class X</h4>
          <h5 className="flex justify-between pl-8 py-1 max-sm:text-xs max-sm:flex-col">
